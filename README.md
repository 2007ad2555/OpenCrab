...
5. Look for the main app file, often named something like `OpenCrab.exe`
...
4. Finish the setup
5. Start OpenCrab from the Start menu or the install folder

### If Windows blocks the file
1. Right-click the file
2. Choose Properties
3. Look for an Unblock box
4. Check it if present
5. Select OK and try again
...
3. Check the default workspace
4. Review the main panels for tasks, ontology items, or plugin settings
5. Save any changes before closing

If the app asks for a folder or workspace path, choose a simple folder such as:
- Documents
- Desktop
- A new folder named `OpenCrab`

## 🧭 Main Parts of the App

OpenCrab is built around structured agent work. You will likely see sections like these:

- **Workspace** — the place where your project lives
- **Ontology view** — a structured list of concepts, types, or objects
- **Task panel** — where you set or review work items
- **Plugin area** — where MCP plugin links or agent tools connect
- **Output panel** — where results, logs, or status messages appear
...
- **Language** — set the app language if the option exists
- **Theme** — switch between light and dark mode
- **Workspace path** — choose where files are stored
- **Auto-save** — keep changes saved as you work
- **Log view** — show or hide debug output
...
2. Confirm you extracted the ZIP if needed
3. Try running the app as administrator
4. Close and reopen the app
5. Reboot Windows if the issue stays
...
3. Open the app
4. Create a workspace called `Demo`
5. Add a few core items like `User`, `Task`, and `Result`
6. Link the items
7. Save the workspace
8. Review the output panel
9. Make one small change and save again
